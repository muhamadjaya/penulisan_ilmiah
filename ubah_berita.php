...
$databerita = query("SELECT * FROM tb_berita WHERE id_berita = '$id'")[0];
// var_dump($databerita["deskripsi_wisata"]);
?>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid" style="height: 350px">
        <div class="container text-center text-white font-weight-bold pt-5" style="font-family: 'Manrope', sans-serif;">
            ...
            <h1 class="display-4">Ubah Data Berita</h1>
            <p class="lead">Administrator → Ubah Data Berita</p>
        </div>
    </div>
   <!-- akhir hero -->
  ...
  ?>
      <!-- form -->
      <section class="ubahberitaa mb-5 pb-5 mt-5 pt-5">
    <div class="container" style="font-family: 'Manrope', sans-serif;">
    <div class="row justify-content-center">
      ...
      <div class="col-md-8">
        ...
        <input type="hidden" name="gambarLama" value="<?= $databerita["gambar"]; ?>">
        <div class="form-group row justify-content-center">
            <label for="judul" class="col-sm-3 col-form-label">Judul Berita</label>
            <div class="col-sm-7">
                <input type="text" class="form-control" name="judul" id="judul" required value="<?= $databerita["judul"]; ?>">
            </div>
        </div>
        <div class="form-group row justify-content-center">
            <label for="isi" class="col-sm-3 col-form-label">isi</label>
            <div class="col-sm-7">
                <textarea name="isi" id="isi" class="form-control" required><?= $databerita["isi"]; ?></textarea>
            </div>
        </div>
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-sm-7">
                <img src="img/berita/<?= $databerita["gambar"]; ?>" width="150"> <br>
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="keterangan_gambar" id="keterangan_gambar" required value="<?= $databerita["keterangan_gambar"]; ?>">
            </div>
        </div>
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-sm-7">
                <?php
                  $tglpost = $databerita["tgl_posting"];
                ...
                ?>
                 <input type="text" class="form-control" name="tgl_posting" id="tgl_posting" required value="<?= $tglan; ?>">
               <!--  <input type="text" class="form-control" name="tgl_posting" id="tgl_posting" required value="<?= $databerita["tgl_posting"]; ?>"> -->
            </div>
        </div>
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-sm-7">
                <textarea name="sumber" id="sumber" class="form-control" required><?= $databerita["sumber"]; ?></textarea>
            </div>
        </div>
