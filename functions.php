<?php
// koneksi ke database
$conn = mysqli_connect("localhost","root","","db_giswisatapdg");
...
function tambah($data) {
    ...
    $id_user=strip_tags($data["id_user"]);
     ...
     $query = "INSERT INTO tb_wisata
                VALUES
            ('', '$nama_wisata', '$deskripsi', '$deskripsi2', '$kategori', '$alamat', '$latitude', '$longitude', '$gambar', '$keterangan_gambar', '$video', '$keterangan_video', '$keterangan', '$id_user')
            ";
...
function registrasi($data) {
    ...
    mysqli_query($conn, "INSERT INTO tb_user VALUES('', '$nama', '$username', '$password', '$telepon')");
...
function tambahberita($data) {
    ...
    $id_user=strip_tags($data["id_user"]);
     ...
     $query = "INSERT INTO tb_berita
                VALUES
            ('', '$judul', '$isi', '$tglan', '$sumber', '$gambar', '$keterangan_gambar', '$id_user')
            ";
