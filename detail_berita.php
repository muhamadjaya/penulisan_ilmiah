...
<html lang="en">
  ...
  <body>
   ...
   <!-- detail berita -->
    <section class="detailberita mb-5">
    <div class="container" style="font-family: 'Manrope', sans-serif;">

      <div class="row mt-5 pt-5">
        <div class="col-md-12 text-center">
           <img src="img/berita/<?= $databerita["gambar"]; ?>" class="img-thumbnail">
           <p class="text-center font-italic text-muted"><?= $databerita["keterangan_gambar"]; ?></p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <?php 
              $tanggal = substr($databerita["tgl_posting"],8,2);
              $bulan   = substr($databerita["tgl_posting"],5,2);
              $tahun   = substr($databerita["tgl_posting"],0,4);
      ...
      <div class="row mt-2">
        <div class="col-md-12 text-justify">
          <p><?= $databerita["isi"]; ?></p> 
          <p class="text-muted"><?= $databerita["sumber"]; ?></p>
        </div>
      </div>
