  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid" style="height: 350px">
        <div class="container text-center text-white font-weight-bold pt-5" style="font-family: 'Manrope', sans-serif;">
            ...
            <h1 class="display-4">Kelola Wisata</h1>
            <p class="lead">Administrator → Kelola Wisata</p>
        </div>
    </div>
   <!-- akhir hero -->
   ...
   <!-- kelola wisata -->
    <section class="kelolawisata mb-5">
    <div class="container" style="font-family: 'Manrope', sans-serif;">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <!-- <form action="" method="post" class="form-inline">
          ...
          <a href="tambah_wisata_alam.php" class="btn btn-primary ml-auto">Tambah Data Wisata</a>
        </form> -->
        <!-- akhir cari data -->
        <a href="tambah_wisata_alam.php" class="btn btn-primary ml-auto">Tambah Data Wisata</a>
        <br><br>
        ...
        <table class="table table-bordered table-hover table-responsive-md" id="example">
          <thead class="thead-dark text-center">
            <tr>
                ...
                <th scope="col" style="width: 145px;">Nama Wisata</th>
            ...
            <tr>
                ...
                <td>
                    <img src="img/wisata/<?= $row["gambar"]; ?>" width="130px" class="border border-primary rounded-lg">         
                </td>
                <td>
                    <?= $row["nama_wisata"]; ?>
                </td>
                ...
                <td>
                    <a href="ubah_wisata_alam.php?id_wisata=<?= $row["id_wisata"]; ?>" class="btn btn-warning">Ubah</a>
                    <a href="hapus_wisata_alam.php?id_wisata=<?= $row["id_wisata"]; ?>" class="btn btn-danger" onclick="return confirm('Yakin akan menghapus data ini?');">Hapus</a>
                </td>
            </tr>
            <?php $i++; ?>
            <?php endforeach; ?>
