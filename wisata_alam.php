...
$wisataalam = query("SELECT * FROM tb_wisata WHERE kategori='alam'");

// tombol cari ditekan
if( isset($_POST["cari"]) ) {
  $wisataalam = carialam($_POST["keyword"]);
}
...
<html lang="en">
  ...
  <body>
   ...
   <!-- wisata alam -->
    <section class="wisataalamm mb-5">
    <div class="container" style="font-family: 'Manrope', sans-serif;">
    <div class="row">
      <div class="col-md-12">
        <br><br>
        ...
        <form action="" method="post" class="form-inline">
          <div class="form-group mr-2">
            <input type="text" name="keyword" size="37" autofocus placeholder="  Cari Wisata" autocomplete="off" id="keyword">
          </div>
