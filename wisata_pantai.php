...
$wisatapantai = query("SELECT * FROM tb_wisata WHERE kategori='pantai'");

// tombol cari ditekan
if( isset($_POST["cari"]) ) {
  $wisatapantai = caripantai($_POST["keyword"]);
}
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid" style="height: 350px">
        <div class="container text-center text-white font-weight-bold pt-5" style="font-family: 'Manrope', sans-serif;">
            ...
            <h1 class="display-4">Wisata Pantai</h1>
            <p class="lead">Beranda → Wisata Pantai</p>
        </div>
    </div>
   <!-- akhir hero -->
   ...
   <!-- wisata pantai -->
    <section class="wisatapantai mb-5">
    <div class="container" style="font-family: 'Manrope', sans-serif;">
    <div class="row">
      <div class="col-md-12">
        <br> <br>
        ...
        <form action="" method="post" class="form-inline">
          <div class="form-group mr-2">
            <input type="text" name="keyword" size="37" autofocus placeholder="  Cari Wisata" autocomplete="off" id="keyword-pantai">
          </div>
